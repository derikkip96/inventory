    ...
    window.addEventListener('load', function() {
        ...
        var toggleFunc = function(ev) {
            ...
            if (fieldset.classList.contains('collapsed')) {
                // Show
                this.textContent = gettext('Hstock_ide');
